...
QString TransactionDesc::toHTML(CWallet *wallet, CWalletTx &wtx)
{
...

    {
        ...
        {
            //
            // CoinStake - show individual outputs for clarity
            // Calculate actual credit amount even if unmatured (for display purposes)
            //
            ...
            // Show debits (charity outputs) if any
            ...
            // Update nNet for correct Net amount display
