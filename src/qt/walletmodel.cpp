...
{
	// Legacy function - returns sum of all charity percentages
	// TODO: Update to work with new vStakeForCharity vector
...
{
	// Legacy function - returns first charity address
	// TODO: Update UI to handle multiple addresses
	if (!wallet->fStakeForCharity || wallet->vStakeForCharity.empty())
		return "Not Saving";
...
{
    // Disconnect using stored connection objects
