...
bool CTxDB::LoadBlockIndex()
{
    ...
    while (iterator->Valid())
    {
        ...
        // Note: setStakeSeen will be rebuilt after best chain is determined
        // to only include stakes from blocks on the best chain (not side chains)
    ...
    // MotaCoin: rebuild setStakeSeen to only include stakes from blocks on the best chain
    // This prevents legitimate blocks from being rejected when loading from bootstrap file
    setStakeSeen.clear();
