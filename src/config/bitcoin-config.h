...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The MotaCoin developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "MotaCoin"
...
#define PACKAGE_NAME "MotaCoin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MotaCoin 1.4.0"
