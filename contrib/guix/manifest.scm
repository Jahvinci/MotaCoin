...
(define* (make-motacoin-cross-toolchain target
                                       #:key
...
desirable for building MotaCoin release binaries."
...
(define glibc-2.27/motacoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-motacoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/motacoin-patched
