# Bootstrappable MotaCoin Builds

This directory contains the files necessary to perform bootstrappable MotaCoin
builds.
...
To build MotaCoin reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/motacoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://gitlab.com/MotaCoin/guix.sigs).
